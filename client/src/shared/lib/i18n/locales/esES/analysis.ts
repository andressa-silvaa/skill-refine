export const analysisDomain = {
  analysis: {
    ...
    jobDescriptionLabel: 'Descripción de la vacante (opcional)',
    jobDescriptionPlaceholder: 'Pega aquí el texto de la vacante para un análisis de compatibilidad más preciso...',
    jobDescriptionHint: 'Mejora la precisión de la aderencia al puesto objetivo, pero no es obligatorio.',
