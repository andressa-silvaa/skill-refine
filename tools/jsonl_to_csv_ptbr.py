...
out = r"ml\data\processed\low_confidence_review_ptbr.csv"
...
# delimiter=';' para Excel PT-BR + utf-8-sig para acentos
with open(out, "w", newline="", encoding="utf-8-sig") as f:
    w = csv.DictWriter(f, fieldnames=fields + ["review_label", "review_note"], delimiter=";")
    w.writeheader()
    for r in rows:
        r["review_label"] = ""
        r["review_note"] = ""
